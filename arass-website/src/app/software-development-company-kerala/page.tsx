...
export const metadata: Metadata = {
  title: 'Software Development Company in Kerala | ARASS Tech',
  description: 'Premium digital solutions and services by ARASS Tech.',
  alternates: {
    canonical: 'https://arasstech.com/software-development-company-kerala',
  }
};
...
export default function Page() {
  return (
    <SEOPageLayout>
      <SEOContentSection
        title="Software Development Company in Kerala"
